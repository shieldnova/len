...
const FloatingWhatsApp = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center animate-pulse-bounce transition-transform duration-300">
        <img src={whatsapp} alt="WhatsApp" className="w-7 h-7" />
      </div>
      <span className="overflow-hidden max-w-0 group-hover:max-w-[200px] group-hover:ml-3 whitespace-nowrap transition-all duration-300 text-white font-medium">
        WhatsApp Us
      </span>
    </a>
  );
