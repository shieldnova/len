...
const Contact = () => {
  ...
  return (
    <section id="contact" className='relative py-10 px-6'>
      ...
      {/* Heading */}
      <h2
        className="text-center text-4xl font-extrabold bg-gradient-to-r from-brandColorOne via-brandColorTwo to-brandColorThree bg-clip-text text-transparent"
        data-aos="fade-up"
      >
        Contact Us
      </h2>
      ...
      {/* Subheading */}
      <p
        className="mt-2 max-w-3xl mx-auto text-gray-500 text-center"
        data-aos="fade-up"
        data-aos-delay="100"
      >
      ...
      <div className="bg-white flex items-center justify-center px-6 py-16">
        <div
          className="max-w-3xl w-full bg-white shadow-xl rounded-3xl border border-gray-200 p-8 md:p-12"
          data-aos="zoom-in"
        >
